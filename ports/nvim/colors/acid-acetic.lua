-- Acid 0.1.0 — Acetic, for Neovim
--
-- Generated by acidify from ports/nvim/acid.lua.tera. Do not edit; edit the
...
local groups = {
  ...
  DiffAdd = { bg = "#242808" },
  DiffChange = { bg = "#0a1924" },
  DiffDelete = { fg = p.red, bg = "#240a08" },
  DiffText = { bg = "#163a52" },
  ...
  DiagnosticVirtualTextError = { fg = p.red, bg = "#1f0806" },
  DiagnosticVirtualTextWarn = { fg = p.orange, bg = "#1f1104" },
  DiagnosticVirtualTextInfo = { fg = p.blue, bg = "#08161f" },
  DiagnosticVirtualTextHint = { fg = p.aqua, bg = "#061b16" },
  DiagnosticVirtualTextOk = { fg = p.green, bg = "#181b05" },
...
vim.g.terminal_color_9 = "#ff6b5f"
vim.g.terminal_color_10 = "#d2e54f"
vim.g.terminal_color_11 = "#ffd35b"
vim.g.terminal_color_12 = "#6ec6ff"
vim.g.terminal_color_13 = "#f0a2d4"
vim.g.terminal_color_14 = "#53e5c4"
